...
from readImages.readEXR import ReadExr_SingleChannel #using openEXR
...
class DualPixel(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #conf = cv2.imread(filename=conf_path, flags=-1)[..., [2]]: Trung: to avoid using opencv
        conf = ReadExr_SingleChannel(conf_path)
